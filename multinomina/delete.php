<?php
	...
	else if($subject == 'Archivo_digital')
	{
		...
		elseif(isset($_POST['trabajador']))
			$obj->set('Trabajador',$_POST['trabajador']);
	...
	elseif($subject == 'Empresa_administradora')
	{
	...
	else if($subject == 'Establecimiento')
	{
		include_once('establecimiento.php');

		$obj = new Establecimiento();
		$obj->set('Domicilio',$_POST['Domicilio']);
	}
	...
	else if($subject == 'Recibo_de_vacaciones')
	{
