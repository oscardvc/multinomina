...
//Class Actividad definition
	...
	class Actividad
	{
		...
		{
			$this->conn->query("INSERT INTO Actividad(Usuario, Cuenta, Operacion, Dato, Identificadores, Hora_y_fecha) VALUES ('{$this->Usuario}', '{$_SESSION['cuenta']}', '{$this->Operacion}', '{$this->Dato}', '{$this->Identificadores}', '{$this->Hora_y_fecha}')");
			return true;
		}
