...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cfdi="http://www.sat.gob.mx/cfd/3" xmlns:nomina="http://www.sat.gob.mx/nomina" xmlns:tfd="http://www.sat.gob.mx/TimbreFiscalDigital">
	<xsl:template match="/">
		<html>
			...
			<body style = "padding:0mm; margin:0mm;">

				<xsl:for-each select="Raiz/cfdi:Comprobante">
					<div>
						<xsl:attribute name="style">
							display:block; position:relative; padding:3mm; margin:0mm; border-bottom:0.7mm dotted #ddd; width:209.9mm; height:136mm; background:none;
						</xsl:attribute>
	...
	<xsl:template name="Concepto">
		...
		<xsl:for-each select = "/Raiz/cfdi:Comprobante[position()&#61;$index]/cfdi:Conceptos/cfdi:Concepto">
			<table>
				<xsl:attribute name="style">
					display:block; position:relative; padding:0mm; margin:1mm 0mm 0mm 0mm; border:0.7mm solid #555; width:<xsl:copy-of select="$width" />mm; height:<xsl:copy-of select="$height" />mm; background:none; top:<xsl:value-of select="-35" />mm; overflow: hidden;
				</xsl:attribute>
				...
				<tr>
					...
					<td class = "normal" style = "text-align:right"><xsl:value-of select='format-number(@valorUnitario,"#,###,##0.00")' /></td>
					<td class = "normal"><xsl:value-of select='format-number(@importe,"#,###,##0.00")' /></td>
				</tr>
				<br/>
				<tr>
					<td class = "normal"></td>
					...
					<td class = "normal" style = "text-align:right"><xsl:value-of select='format-number(/Raiz/cfdi:Comprobante[position()&#61;$index]/@subTotal,"#,###,##0.00")' /></td>
				</tr>
				<tr>
					<td class = "normal"></td>
					<td class = "normal"></td>
					...
					<td class = "normal" style = "text-align:right"><xsl:value-of select='format-number(/Raiz/cfdi:Comprobante[position()&#61;$index]/@descuento,"#,###,##0.00")' /></td>
				</tr>
				<tr>
					<td class = "normal"></td>
					<td class = "normal"></td>
					...
					<td class = "normal" style = "text-align:right;border-top:1px solid #555"><xsl:value-of select='format-number(/Raiz/cfdi:Comprobante[position()&#61;$index]/@subTotal - /Raiz/cfdi:Comprobante[position()&#61;$index]/@descuento,"#,###,##0.00")' /></td>
				</tr>
				<tr>
					<td class = "normal"></td>
					<td class = "normal"></td>
					...
					<td class = "normal" style = "text-align:right;"><xsl:value-of select='format-number(/Raiz/cfdi:Comprobante[position()&#61;$index]/cfdi:Impuestos/cfdi:Retenciones/cfdi:Retencion/@importe,"#,###,##0.00")' /></td>
				</tr>
				<tr>
					<td class = "normal"></td>
					<td class = "normal"></td>
					...
					<td class = "normal" style = "text-align:right;border-top:1px solid #555"><xsl:value-of select='format-number(/Raiz/cfdi:Comprobante[position()&#61;$index]/@total,"#,###,##0.00")' /></td>
				</tr>
			</table>
	...
	<xsl:template name="ComplementoNomina">
		...
		<xsl:for-each select = "/Raiz/cfdi:Comprobante[position()&#61;$index]/cfdi:Complemento/nomina:Nomina">
			<table>
				<xsl:attribute name="style">
					display:block; position:relative; padding:0mm; margin:2mm 0mm 0mm 0mm; border:0.7mm solid #555; width:<xsl:copy-of select="$width" />mm; height:<xsl:copy-of select="$height" />mm; background:none; top:<xsl:value-of select="-76" />mm; left:82mm; overflow: hidden;
				</xsl:attribute>
					...
					<xsl:when test="count(nomina:Percepciones/nomina:Percepcion) &gt;= count(nomina:Deducciones/nomina:Deduccion)">
						<xsl:for-each select = "nomina:Percepciones/nomina:Percepcion">
							...
							<tr>
								...
								<td class = "normal" style = "text-align:right"><xsl:value-of select='format-number(@ImporteGravado + @ImporteExento,"#,###,##0.00")' /></td>
								<td class = "normal">
								...
								<td class = "normal" style = "text-align:right">
									...
									<xsl:if test = '/Raiz/cfdi:Comprobante[position()&#61;$index]/cfdi:Complemento/nomina:Nomina/nomina:Deducciones/nomina:Deduccion[position() = $i]/@Concepto'>
										<xsl:value-of select='format-number(/Raiz/cfdi:Comprobante[position()&#61;$index]/cfdi:Complemento/nomina:Nomina/nomina:Deducciones/nomina:Deduccion[position() = $i]/@ImporteGravado + /Raiz/cfdi:Comprobante[position()&#61;$index]/cfdi:Complemento/nomina:Nomina/nomina:Deducciones/nomina:Deduccion[position() = $i]/@ImporteExento,"#,###,##0.00")' />
									</xsl:if>
						...
						<xsl:for-each select = "nomina:Deducciones/nomina:Deduccion">
							...
							<tr>
								...
								<td class = "normal" style = "text-align:right">
									...
									<xsl:if test = '/Raiz/cfdi:Comprobante[position()&#61;$index]/cfdi:Complemento/nomina:Nomina/nomina:Percepciones/nomina:Percepcion[position() = $i]/@Concepto'>
										<xsl:value-of select='format-number(/Raiz/cfdi:Comprobante[position()&#61;$index]/cfdi:Complemento/nomina:Nomina/nomina:Percepciones/nomina:Percepcion[position() = $i]/@ImporteGravado + /Raiz/cfdi:Comprobante[position()&#61;$index]/cfdi:Complemento/nomina:Nomina/nomina:Percepciones/nomina:Percepcion[position() = $i]/@ImporteExento,"#,###,##0.00")' />
									</xsl:if>
				...
				<tr>
					<td></td>
					<td class = "normal" style = "text-align:right; border-top:1px Solid #999">$ <xsl:value-of select='format-number(nomina:Percepciones/@TotalGravado + nomina:Percepciones/@TotalExento,"#,###,##0.00")' /></td>
					<td></td>
					<td class = "normal" style = "text-align:right; border-top:1px Solid #999">$ <xsl:value-of select='format-number(nomina:Deducciones/@TotalGravado + nomina:Deducciones/@TotalExento,"#,###,##0.00")' /></td>
				</tr>
				<tr>
					<td class = "title">Total</td>
					<td class = "normal" style = "text-align:right;">$ <xsl:value-of select='format-number(nomina:Percepciones/@TotalGravado + nomina:Percepciones/@TotalExento - nomina:Deducciones/@TotalGravado - nomina:Deducciones/@TotalExento,"#,###,##0.00")' /></td>
					<td></td>
					<td></td>
				</tr>
			</table>
	...
	<xsl:template name="TimbreFiscalDigital">
		...
		<xsl:for-each select = "/Raiz/cfdi:Comprobante[position()&#61;$index]/cfdi:Complemento/tfd:TimbreFiscalDigital">
			<table>
				<xsl:attribute name="style">
					display:block; position:relative; padding:0mm; margin:2mm 0mm 0mm 0mm; border:none; width:<xsl:copy-of select="$width div 2" />mm; height:20mm; background:none; top:-85mm; overflow: hidden;
				</xsl:attribute>
			...
			<table>
				<xsl:attribute name="style">
					display:block; position:relative; padding:0mm; margin:2mm 0mm 0mm 0mm; border:none; width:<xsl:copy-of select="$width" />mm; height:18mm; background:none; top:-96mm; overflow: hidden;
				</xsl:attribute>
			...
			<table>
				<xsl:attribute name="style">
					display:block; position:relative; padding:0mm; margin:2mm 0mm 0mm 0mm; border:none; width:<xsl:copy-of select="$width div 2" />mm; height:8mm; background:none; top:-99mm; overflow: hidden;
				</xsl:attribute>
			...
			<table>
				<xsl:attribute name="style">
					display:block; position:relative; padding:0mm; margin:2mm 0mm 0mm 0mm; border:none; width:<xsl:copy-of select="$width" />mm; height:20mm; background:none; top:-102mm; overflow: hidden;
				</xsl:attribute>
			...
			<img src = "cbb.png">
				<xsl:attribute name="style">
					display:block; position:relative; padding:0mm; margin:0mm 0mm 0mm 6mm; border:0.7mm solid #555; width:38mm; height:38mm; background:none; top:-148mm; left:<xsl:copy-of select="$width" />mm;
				</xsl:attribute>
			</img>
		</xsl:for-each>
